...
const ispReportSuperAdminMenu = (t: (key: string) => string) => ({
    title: t('ISP Report'),
    icon: FileBarChart2,
    name: 'isp-report',
    menuKey: 'isp-report',
    ...
    children: [
        ...
        },
        {
            ...
            menuKey: 'isp-report-connection-logs',
        ...
        },
        {
            ...
            menuKey: 'isp-report-payment-logs',
...
export default ispReportSuperAdminMenu;
export { ispReportSuperAdminMenu };
