...
const tr069SuperAdminMenu = (t: (key: string) => string) => ({
    title: t('TR069'),
    icon: RadioTower,
    name: 'tr069',
    menuKey: 'tr069',
...
export default tr069SuperAdminMenu;
