...
export default function MarketplaceHero({ settings, title: propTitle, subtitle: propSubtitle, primaryButton, secondaryButton }: MarketplaceHeroProps) {
    ...
    const subtitle = propSubtitle || sectionData.subtitle || 'Extend your StudyRoomTechLab WiFi Billing with powerful premium modules. From advanced Customer Accounts to specialized industry solutions.';
