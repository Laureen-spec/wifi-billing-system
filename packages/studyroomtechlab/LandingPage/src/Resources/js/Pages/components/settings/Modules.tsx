                ...
                <CardContent className="space-y-6">
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            placeholder={t('Discover our comprehensive modules designed to streamline every aspect of your ISP operations')}
                            rows={3}
                        />
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <Repeater
                            fields={[
                                ...
                                { name: 'title', label: t('Module Title'), type: 'text', placeholder: t('ISP Billing Dashboard'), required: true },
