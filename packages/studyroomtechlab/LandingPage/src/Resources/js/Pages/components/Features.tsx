...
export default function Features({ settings }: FeaturesProps) {
    ...
    const defaultFeatures = [
        ...
        { title: 'ISP Billing', description: 'Advanced financial management', icon: 'Calculator' },
        { title: 'Customer Accounts', description: 'Customer relationship management', icon: 'Users' }
    ];
