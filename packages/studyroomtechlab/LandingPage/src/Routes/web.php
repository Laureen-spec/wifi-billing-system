...
use StudyRoomTechLab\LandingPage\Http\Controllers\LandingPageController;
use StudyRoomTechLab\LandingPage\Http\Controllers\MarketplaceController;
use StudyRoomTechLab\LandingPage\Http\Controllers\CustomPageController;
use StudyRoomTechLab\LandingPage\Http\Controllers\NewsletterSubscriberController;
...
// Authenticated Add-on Management Routes
Route::middleware(['web', 'auth'])->group(function () {
    Route::patch('/addons/{addon}/toggle', [LandingPageController::class, 'toggleAddon'])->name('addons.toggle');
});
