    ...
    public function run()
    {
        $pages = [
            [
                ...
                'content' => '<div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                        ...
                        <div class="bg-gray-100 rounded-lg p-8">
                            ...
                            <p class="text-gray-600 leading-relaxed">To be the leading provider of comprehensive ISP billing solutions that transform how companies operate and succeed.</p>
                        </div>
                    </div>
                ...
                'meta_description' => 'Discover our story, mission, and vision. Learn why we are the trusted choice for ISP billing solutions.',
                'is_active' => true,
                'is_disabled' => false
            ],
            [
            ...
            [
                ...
                'content' => '<div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="bg-white border rounded-lg p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-3">What is StudyRoomTechLab WiFi Billing?</h3>
                            <p class="text-gray-600 leading-relaxed">StudyRoomTechLab WiFi Billing is a comprehensive ISP billing platform that helps companies streamline their operations, manage projects, and improve productivity through integrated tools and modules.</p>
                        </div>
                        ...
                        <div class="bg-white border rounded-lg p-6">
                            ...
                            <p class="text-gray-600 leading-relaxed">Yes! StudyRoomTechLab WiFi Billing offers extensive customization options including custom fields, workflows, dashboards, and integrations with third-party tools.</p>
                        </div>
                    </div>
                ...
                'meta_description' => 'Find answers to common questions about our ISP billing platform and services.',
                'is_active' => true,
                'is_disabled' => false
            ],
            [
