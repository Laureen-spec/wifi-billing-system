...
use StudyRoomTechLab\LandingPage\Models\MarketplaceSetting;
        ...
        if (File::exists($marketplaceDir)) {
            ...
            foreach ($files as $file) {
                if (in_array($file->getExtension(), ['png', 'jpg', 'jpeg', 'gif', 'webp'])) {
                    $screenshots[] = '/packages/StudyRoomTechLab/LandingPage/src/marketplace/' . $file->getFilename();
                }
            }
        }
        ...
        MarketplaceSetting::firstOrCreate(['module' => 'LandingPage'], [
            ...
            'config_sections' => [
                'sections' => [
                    'hero' => [
                        'variant' => 'hero1',
                        'title' => 'Landing Page Builder for StudyRoomTechLab WiFi Billing',
                    ...
                    'dedication' => [
                        ...
                        'subSections' => [
                            [
                                ...
                                'screenshot' => '/packages/StudyRoomTechLab/LandingPage/src/marketplace/image1.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/StudyRoomTechLab/LandingPage/src/marketplace/image2.png'
                            ],
                            [
                                ...
                                'screenshot' => '/packages/StudyRoomTechLab/LandingPage/src/marketplace/image3.png'
                            ]
                        ]
                    ],
                    'screenshots' => [
