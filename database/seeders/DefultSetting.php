...
class DefultSetting extends Seeder
{
    ...
    public function run()
    {
            ...
            $admin_settings = [
                ...
                'favicon' => 'favicon.png',
                'titleText' => !empty(env('APP_NAME')) ? env('APP_NAME') : 'StudyRoom TechLab Billing',
                'footerText' => 'Powered by StudyRoom TechLab',
                ...
                // SEO Settings
                'metaKeywords' => 'studyroom techlab, isp billing, wifi billing, mikrotik billing',
                'metaTitle' => !empty(env('APP_NAME')) ? env('APP_NAME') . ' - Dashboard' : 'StudyRoom ISP Billing - Dashboard',
                'metaDescription' => 'Professional ISP billing and WiFi management system.',
