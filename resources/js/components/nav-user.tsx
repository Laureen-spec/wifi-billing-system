...
export function NavUser({
  ...
  const settingsAccessPermissions = [
    "manage-settings",
    "manage-dashboard",
  ...
  const canManageSettings = isSuperAdmin || settingsAccessPermissions.some((permission) => permissions.includes(permission))
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuGroup>
              ...
              {canManageSettings && (
                <DropdownMenuItem asChild className="cursor-pointer rounded-xl px-3 py-2.5">
                  <Link href={route("settings.index") + (isSuperAdmin ? "#payment-gateway-settings" : "#admin-settings")}>
