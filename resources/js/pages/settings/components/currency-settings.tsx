...
export default function CurrencySettings({ userSettings = {}, auth }: CurrencySettingsProps) {
    ...
    const [currencySettings, setCurrencySettings] = useState({
        decimalFormat: userSettings?.decimalFormat || '0',
        defaultCurrency: userSettings?.defaultCurrency || 'KES',
        decimalSeparator: userSettings?.decimalSeparator || '.',
        thousandsSeparator: userSettings?.thousandsSeparator || ',',
        floatNumber: userSettings?.floatNumber === '1' ? true : false,
        currencySymbolSpace: userSettings?.currencySymbolSpace === '0' ? false : true,
        currencySymbolPosition: userSettings?.currencySymbolPosition || 'before',
        currencySymbol: userSettings?.currencySymbol || 'KES',
        currencyName: ''
    });
