...
export default function BrandSettings({ userSettings, auth }: BrandSettingsProps) {
  ...
  const [settings, setSettings] = useState<BrandSettings>({
    ...
    titleText: userSettings?.titleText || 'StudyRoom TechLab Billing',
    footerText: userSettings?.footerText || 'Powered by StudyRoom TechLab',
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      placeholder={t('Powered by StudyRoom TechLab')}
                      disabled={!canEdit}
                    />
                    <p className="text-xs text-muted-foreground">
