...
import { formatAdminCurrency, formatDate, getPackageFavicon, getPackageAlias, getSubscriptionDetails } from '@/utils/helpers';
            ...
            <div className="lg:col-span-3 space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div className="space-y-3 text-sm">
                        ...
                        <div className="flex justify-between">
                            <span className="text-gray-600 dark:text-gray-400">{t('Routers')}</span>
                            <span className="font-medium text-gray-900 dark:text-white">{t('Included')}</span>
                        </div>
                            <div className="flex justify-between">
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span className="text-sm font-medium">{t('Hotspot Collections')}</span>
                                    </div>
                                    <span className="text-sm text-gray-600 dark:text-gray-400">{t('Included')}</span>
                                </div>
                                {plan.trial && (
