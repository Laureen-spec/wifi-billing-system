...
const getPackageComponents = (activatedPackages: string[]) => {
  ...
  try {
    const modules = {
      ...import.meta.glob('../../../packages/studyroomtechlab/*/src/Resources/js/settings/components/*.tsx'),
      ...import.meta.glob('../../../packages/workdo/*/src/Resources/js/settings/components/*.tsx'),
    };
