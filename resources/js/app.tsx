...
createInertiaApp({
    ...
    resolve: (name) => {
        const allPages = {
            ...
            ...import.meta.glob('../../packages/studyroomtechlab/*/src/Resources/js/pages/**/*.tsx'),
        ...
        const packagePagePath = Object.keys(allPages).find((path) => (
            path.endsWith(`/src/Resources/js/pages/${name}.tsx`)
            || path.endsWith(`/src/Resources/js/Pages/${name}.tsx`)
        ));
        ...
        for (const packageRoot of packageRoots) {
            const packagePagePath = `../../packages/${packageRoot}/${packageName}/src/Resources/js/Pages/${pagePath.join('/')}.tsx`;
